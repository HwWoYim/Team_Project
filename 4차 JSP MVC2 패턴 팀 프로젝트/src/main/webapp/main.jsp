               ...
               <div class="row no-gutters">
                  ...
                  <div class="col-md-8 d-flex align-items-center">
                     <div class="services-wrap rounded-right w-100 mainService">
                        <h3 class="heading-section mb-4">VARCHAR와 함께 중고차 시작하기</h3>
                           ...
                           <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                              <div class="services w-100 text-center">
                                 ...
                                 <div class="text w-100">
                                    <h3 class="heading mb-2">당신에게 가까운 매장이 어디일까요 ?</h3>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                              <div class="services w-100 text-center">
                                 ...
                                 <div class="text w-100">
                                    <h3 class="heading mb-2">최고의 딜러들을 만나보고 싶으신가요 ?</h3>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                              <div class="services w-100 text-center">
                                 ...
                                 <div class="text w-100">
                                    <h3 class="heading mb-2">당신이 필요로 하는 자가 없나요 ?</h3>
                                 </div>
                              </div>
                           </div>
                        </div>
      ...
      <div class="container">
         <div class="row justify-content-center">
            <div class="col-md-12 heading-section text-center ftco-animate mb-5">
               ...
               <span class="subheading">중고차가 어려운 당신을 위한 오토벨 112가지 진단,
      ...
      <div class="container">
         <div class="row justify-content-end">
            <div
               ...
               <h2 class="mb-3">
                  지금 회원가입하고<br> 오토벨의 모든 서비스를 편리하게 이용하세요
               </h2>
               <a href="#" class="btn btn-primary btn-lg">로그인 하기</a> <a href="#"
                  class="btn btn-primary btn-lg">회원 가입하기</a>
            </div>
         </div>
      </div>
   </section>
